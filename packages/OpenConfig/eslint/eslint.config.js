...
export default [
  {
    ...
    rules: {
      ...
      // "no-new-symbol": "error", Replaced with "no-new-native-nonconstructor"
      "no-obj-calls": "error",
      ...
      "no-restricted-imports": ["warn", ...bannedImports],
      ...
      "require-yield": "warn",
      "sort-imports": "warn",
      "sort-keys": ["warn", "asc", { allowLineSeparatedGroups: true, minKeys: 4 }],
      "sort-vars": "warn",
      "spaced-comment": "warn",
      strict: "warn",
